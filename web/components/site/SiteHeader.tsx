...
export default function SiteHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-6 md:px-12 lg:px-16 2xl:px-24 py-4 2xl:py-8 flex items-center justify-between bg-transparent backdrop-blur-sm border-b border-white/5">
