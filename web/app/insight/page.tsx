    ...
    <div className="relative w-screen h-screen bg-[#020202] overflow-hidden font-sans text-white selection:bg-green-500/30 selection:text-green-200 flex flex-col">
      ...
      {showContent && (
        <motion.div 
          ...
          className="relative z-10 flex-1 container mx-auto p-6 md:p-8 flex flex-col max-w-[1400px] min-h-0"
        >
          {/* Sub Header: 周切换器 */}
          ...
          {/* Main Grid */}
          <div className="flex-1 grid grid-cols-1 md:grid-cols-12 gap-6 pb-8 min-h-0 overflow-hidden">
            ...
            {/* 🔮 中军：核心简报 (C位) */}
            <div className="col-span-1 md:col-span-6 flex flex-col gap-6 min-h-0">
                <ErrorBoundary name="WeeklyBrief">
                  <TiltCard className="flex-[3] w-full min-h-0">
                      <div className="w-full h-full bg-[#0a0a0a]/90 border border-white/10 p-8 md:p-12 rounded-3xl backdrop-blur-xl hover:border-green-500/20 transition-all shadow-2xl relative overflow-hidden group flex flex-col justify-center">
                          ...
                          <div className="relative z-10 px-4 overflow-y-auto custom-scrollbar max-h-[300px]">
                              <TypingEffect text={report?.content || '本周暂无智能简报。快去摄入一些新鲜信息吧。'} speed={25} />
                          </div>
                          
                          <div className="absolute bottom-6 right-8 text-[9px] font-mono text-white/10 tracking-widest uppercase">
                              GENERATED BY NEO_CORE v2.5 // {report?.id?.slice(0, 8) || 'SYSTEM_IDLE'}
                          </div>
                      </div>
                  </TiltCard>
                </ErrorBoundary>
                ...
                <ErrorBoundary name="IngestionMap">
                  <div className="h-24 bg-[#080808]/80 border border-white/10 p-6 rounded-3xl backdrop-blur-md flex items-center justify-between px-10 hover:border-green-500/20 transition-all shrink-0">
            ...
            <div className="col-span-1 md:col-span-3 flex flex-col gap-6 min-h-0">
                ...
                <div className="h-24 bg-[#080808]/60 border border-white/10 p-5 rounded-3xl backdrop-blur-md flex items-center overflow-hidden relative shrink-0">
